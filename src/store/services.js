...
function api_v1_customtext_update(action) {
  return alineMobileOctAPI.put(`/api/v1/customtext/${action.id}/`, null, {
    data: action.data
  })
}
function api_v1_customtext_partial_update(action) {
  return alineMobileOctAPI.patch(`/api/v1/customtext/${action.id}/`, null, {
    data: action.data
  })
}
...
function api_v1_homepage_update(action) {
  return alineMobileOctAPI.put(`/api/v1/homepage/${action.id}/`, null, {
    data: action.data
  })
}
function api_v1_homepage_partial_update(action) {
  return alineMobileOctAPI.patch(`/api/v1/homepage/${action.id}/`, null, {
    data: action.data
  })
}
...
function api_v1_product_create(action) {
  return alineMobileOctAPI.post(`/api/v1/product/`, null, { data: action.data })
}
...
function api_v1_product_update(action) {
  return alineMobileOctAPI.put(`/api/v1/product/${action.id}/`, null, {
    data: action.data
  })
}
function api_v1_product_partial_update(action) {
  return alineMobileOctAPI.patch(`/api/v1/product/${action.id}/`, null, {
    data: action.data
  })
}
...
function api_v1_signup_create(action) {
  return alineMobileOctAPI.post(`/api/v1/signup/`, null, { data: action.data })
}
function rest_auth_login_create(action) {
  return alineMobileOctAPI.post(`/rest-auth/login/`, null, {
    data: action.data
  })
}
...
function rest_auth_password_change_create(action) {
  return alineMobileOctAPI.post(`/rest-auth/password/change/`, null, {
    data: action.data
  })
}
function rest_auth_password_reset_create(action) {
  return alineMobileOctAPI.post(`/rest-auth/password/reset/`, null, {
    data: action.data
  })
}
function rest_auth_password_reset_confirm_create(action) {
  return alineMobileOctAPI.post(`/rest-auth/password/reset/confirm/`, null, {
    data: action.data
  })
}
function rest_auth_registration_create(action) {
  return alineMobileOctAPI.post(`/rest-auth/registration/`, null, {
    data: action.data
  })
}
function rest_auth_registration_verify_email_create(action) {
  return alineMobileOctAPI.post(`/rest-auth/registration/verify-email/`, null, {
    data: action.data
  })
}
...
function rest_auth_user_update(action) {
  return alineMobileOctAPI.put(`/rest-auth/user/`, null, { data: action.data })
}
function rest_auth_user_partial_update(action) {
  return alineMobileOctAPI.patch(`/rest-auth/user/`, null, {
    data: action.data
  })
}
